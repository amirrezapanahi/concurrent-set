//CODE TAKEN FROM: https://github.com/itsmesac/ConcurrentLinkedList/blob/master/test_nb/amr.cpp
...
bool AtomicMarkableReference::compareAndSet(UINT64 expectedReference, UINT64 updatedReference, bool expectedMark, bool updatedMark)
{
	...
	return addrAndFlag.compare_exchange_weak(expected,updated);
}
...
bool AtomicMarkableReference::attemptMark(UINT64 expectedReference, bool newMark)
{
	...
	return addrAndFlag.compare_exchange_weak(expectedReference,updatedReference);
}

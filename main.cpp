...
int main(int argc, char*argv[]){
  ...
  // if (implementation.compare("cset") == 1){    
  //   set = &cset;
  // }else if (implementation.compare("fset") == 1){
  //   set = &fset;
  // }else if (implementation.compare("lset") == 1){
  //   set = &lset;
  // }else if (implementation.compare("nbset") == 1){
  //   set = &nbset;
  // }else{
  //   cout << "usage: ./main <NUM_THREAD> <IMPLEMENTATION>" << endl;
  //   cout << "IMPLEMENTATION: \n" << endl;
